...
var BasicLayout = function BasicLayout(props) {
  ...
  var getSiderHook = function getSiderHook() {
    return {
      addSider: function addSider(id) {
        setSiders([].concat((0, _toConsumableArray2["default"])(siders), [id]));
      },
      removeSider: function removeSider(id) {
        setSiders(siders.filter(function (currentId) {
          return currentId !== id;
        }));
      }
    };
